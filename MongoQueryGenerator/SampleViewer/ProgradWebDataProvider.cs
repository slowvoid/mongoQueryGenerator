...
namespace SampleViewer
{
    ...
    public static class ProgradWebDataProvider
    {
        ...
        public static RequiredDataContainer MapEntitiesToCollectionsCursoDisciplinaEmbedded()
        {
            // MongoDB Schema
            MongoDBCollection AlunoCol = new MongoDBCollection( "Aluno" );
            AlunoCol.AddAttributes( "_id", "nomealu_alug", "datanasc_alug", "cpf_alug", "endif_alug" );
            ...
            MongoDBCollection EnfaseCol = new MongoDBCollection( "Enfase" );
            EnfaseCol.AddAttributes( "_id", "nomeenf_enf", "siglaenf_enf", "curso.cursoId", "curso.sigla", "curso.nome", "disciplinas_multivalued_" );
            ...
            ModelMapping Map = new ModelMapping( "ProgradwebMap", new List<MapRule>() { AlunoRule, EnderecoRule, EnfaseRule, MatriculaRule, EnderecoAlunoRule, CursoEnfaseRule, DisciplinaGradeRule, EnfaseGradeRule, AlunoMatriculaRule, EnfaseMatriculaRule, DisciplinaEnfaseRule, GradeEnfaseRule } );
