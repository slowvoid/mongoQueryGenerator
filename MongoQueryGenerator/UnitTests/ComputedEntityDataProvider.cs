...
namespace QueryBuilder.Tests
{
    ...
    public static class ComputedEntityDataProvider
    {
        ...
        public static RequiredDataContainer OneToOneComputedEntityMultiple2()
        {
            ...
            MapRule InsurancePersonRule = new MapRule( Insurance, PersonCol, false );
            InsurancePersonRule.AddRule( "insuranceId", "insuranceId" );

            ModelMapping Map = new ModelMapping( "Map", new List<MapRule> { PersonRule, CarRule, GarageRule, RepairedRule, SupplierRule, InsuranceRule, CarPersonRule, CarRepairedRule, GarageRepairedRule, SupplierRepairedRule, InsurancePersonRule } );
        ...
        public static RequiredDataContainer OneToManyComputedEntity()
        {
            ...
            MapRule PersonCarRule = new MapRule( Person, CarCol, false );
            ...
            ModelMapping Map = new ModelMapping( "Map", new List<MapRule> { PersonRule, CarRule, GarageRule, RepairedRule, SupplierRule, InsuranceRule, PersonCarRule, CarRepairedRule, GarageRepairedRule, SupplierRepairedRule, InsurancePersonRule } );
