...
let dbConn = mongoose.createConnection('mongodb://localhost/researchManyToManyRelationshipAttributes')
...
for (let i = 0; i < 10; i++) {
    let model = new insuranceModel({
        ...
        insuranceValue: faker.random.number({min: 10000, max: 300000}),
        aRandomValue: faker.random.uuid()
    })
